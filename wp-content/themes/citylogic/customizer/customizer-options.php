...
function citylogic_customizer_library_options() {
    ...
    $options['citylogic-default-slider-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="https://www.outtheboxthemes.com/documentation/citylogic/homepage-slider/default-slider/" target="_blank">Read a guide on how to set up the Default Slider</a>', 'citylogic' ),
    );
    ...
    $options['citylogic-slider-plugin-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="https://www.outtheboxthemes.com/documentation/citylogic/homepage-slider/slider-plugin/" target="_blank">Read a guide on using a slider plugin</a>', 'citylogic' ),
    );
